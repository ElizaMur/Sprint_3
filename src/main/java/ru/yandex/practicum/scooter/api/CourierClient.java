...
import ru.yandex.practicum.scooter.api.model.CourierWithRequiredFields;
...
public class CourierClient extends BaseApiClient {
    ...
    public Response createCourierWithRequiredFields(CourierWithRequiredFields courierWithRequiredFields) {
        return given()
                .spec(getReqSpec())
                .body(courierWithRequiredFields)
                .when()
                .post(BASE_URL + "/api/v1/courier/");
    }
